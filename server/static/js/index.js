...
//   var words = [["Airbus", 23.0], ["China", 17.0], ["fighter", 14.0], ["wheat", 14.0], ["crops", 11.0], ["Boeing", 11.0], ["trade", 11.0], ["BAE", 11.0], ["Morgan", 10.0], ["Stanley", 10.0], ["harvest", 10.0], ["K", 9.0], ["output", 9.0], ["Britain", 8.0], ["Williamson", 8.0], ["probe", 8.0], ["farm", 8.0], ["waivers", 8.0], ["growth", 8.0], ["states", 8.0]];
//   WordCloud.minFontSize = "15px"
//   WordCloud(document.getElementById('canvas'), { list: words } );
// } 
...
function InitHotwords(url) {
  console.log(url);
  var response = $.getJSON(url, GenerateWordCloud);
  //GenerateWordCloud(response)
}
function GenerateWordCloud(response) {
  var words = response
  var opt = {
    list: words,
    //shape: "diamond",
  ...
  WordCloud(document.getElementById('canvas'), opt);
}
